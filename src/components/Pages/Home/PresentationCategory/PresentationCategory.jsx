...
const PresentationCategory = () => {
    ...
    return (
        <div className="bg-[#fff] dark:bg-[#080808]">
            <div className="w-11/12 mx-auto py-14">
            <div className="">
            <h1 className="text-[28px] text-[#0D0D0D]  dark:text-white font-sans  uppercase font-bold"><span className="text-[#D9042B]">La</span>test presentation</h1>
