    ...
    return (
        <div className='min-h-screen'>
            <div className="mt-32 mb-14 w-10/12 md:w-9/12 mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ">
                ...
                {
                    blogs.map(blog => <div key={blog._id} className='border p-2 card shadow-md overflow-auto flex flex-col'>
                        ...
                        <p className='text-[#525866] text-[13px] leading-[18px] font'>{blog.date}</p>
                        <img className='rounded-lg my-2 mt-auto' src={blog.coverImage} alt="" />
