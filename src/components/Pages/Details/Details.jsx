    ...
    return (
        <div className="dark:bg-[#080808]">
            ...
            <div className="w-11/12 md:w-11/12 lg:w-8/12 mx-auto py-20 ">
                <div className=" rounded-none bg-base-100 border border-1 dark:border-[#222] p-4 dark:bg-[#181718] dark:text-white">
                    <div className="card md:card-side">
                        <img className="h-[400px] w-[310px]" src={document.image} alt="cover-img" />
                        <div className="leading-8 md:leading-10 my-10 ml-1 md:ml-6">
