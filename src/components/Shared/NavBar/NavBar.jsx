                    ...
                    <div className="py-1 px-6 md:px-0">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center justify-end ">
                                ...
                                <div className="peer-checked:translate-x-0 fixed inset-0 w-[calc(100%-4.5rem)] translate-x-[-100%] shadow-xl transition duration-300 lg:border-r-0 lg:w-auto lg:static lg:shadow-none lg:translate-x-0 bg-[#09212E]">
                                    <div className="flex flex-col h-full justify-between lg:items-center lg:flex-row">
                                        <ul className="pt-32 text-[#fff] md:pl-14 font-mono font-semibold text-[14px] space-y-8  lg:space-y-0 lg:flex  lg:pt-0 ">
                                            ...
                                            <li>
                                                <Link to="/upload" className="text-white hover:bg-[#243F4E] hover:text-[#FFBE30] px-8 py-3 rounded-sm">
                                                    Upload
                                                </Link>
                                            </li>
                                        </ul>
                                        ...
                                        <div className="border-t py-8 px-6 md:px-12 md:py-16 lg:border-t-0 lg:py-0 lg:pr-0 lg:pl-6">
                                            <Link to="/signin" className="block px-4 py-2 rounded bg-[#FFBE30] text-black font-bold">
                                                Login
                                            </Link>
                                        </div>
